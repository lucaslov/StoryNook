...
interface SelectedMoviesProps {
  ...
  triggerRecommendations: () => void;  // Added to trigger recommendation process
}

const SelectedMovies = ({ selectedMovies, removeMovie, triggerRecommendations }: SelectedMoviesProps) => {
  return (
    <Box sx={{
      width: '30vw',
      display: 'flex',
